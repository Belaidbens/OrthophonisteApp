...
public class Enfant extends Patient{
    ...
    public Enfant( String nom, String prenom, LocalDate dateDeNaissance, String adresse, String telephone, String email, String LieuDeNaissance, String Classeetude, String telephonemom) {
